<!DOCTYPE html>
    ...
    <body>
        <div class="jumbotron drug-header" id="fentanyl-header">
            ...
            <br>
            <p id="paragraph">Meperidine is an opioid analgesic that is used to manage severe pain. 
            </p>
        </div>
                            ...
                            <div class="col" style="width: 40%;">
                                <div class="card text-dark bg-light mb-3 card-info">
                                    ...
                                    <div class="card-body text-danger">
                                        ...
                                        <p class="card-text-fentanyl">Meperidine is considered a Schedule II drug because of its high potential for abuse, physical/psychological dependency, and can be dangerous.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col" style="width: 40%;">
                ...
                <div class ="container" id="accordion-box">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Meperidine is a synthetic opioid that was created have the same effect as morphine but still being useful for pain relief. 
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse show" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                Meperidine is typically administered intravenously (IV), as an injectible solution, as an oral tablet, or as an oral solution.
                            </div>
                        </div>
                    </div>
                </div>   
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" id="FirstCarousel" >
                            <img src="medpictures/demerol.jpg" height="400">
                        </div>
                        <div class="carousel-item" id="image2">
                            <img src="medpictures/meperidine.jpg" height="400">
                        </div>
                    </div>
            ...
            <div class="container">
                <div id="background">
                    <div class="card text-dark bg-light mb-3 card-info">
                        ...
                        <div class="card-body">
                            Meperidine is formed as a hydrochloride salt synthetic form of an opioid that is used to treat pain. 
                            Meperidine is used for the treatment of moderate to severe pain. It has intramuscular, subcutaneous, intravenous injection, syrup, and tablet forms. 
                            In the 20th century, it was the drug of choice among the opioids in the management of acute pain and the management of some patients with chronic pain.
                        </div>
                    </div>
                </div>
                <div>
