                            ...
                            <div class="col" style="width: 40%;">
                                <div class="card text-dark bg-light mb-3 card-info">
                                    ...
                                    <div class="card-body text-danger">
                                        ...
                                        <p class="card-text-fentanyl">Hydromorphone is considered a Schedule II drug because of its high potential for abuse, physical/psychological dependency, and can be dangerous.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col" style="width: 40%;">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Hydromorphone is a semi-synthetic opioid that derives from morphine.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" id="FirstCarousel" >
                            <img src="medpictures/dilaudid.jpg" height="400">
                        </div>
                        <div class="carousel-item" id="image2">
                            <img src="medpictures/hydromorphone.jpg" height="400">
                        </div>
                        <div class="carousel-item" id="image3">
                            <img src="medpictures/hydroinjection.jpg" height="400">
                        </div>
                    </div>
            ...
            <div class="container">
                <div id="background">
                    <div class="card text-dark bg-light mb-3 card-info">
                        ...
                        <div class="card-body">
                            Hydromorphone is a pure opioid, a semi-synthetic hydrogenated ketone derivative of morphine that has been available clinically since 1920. 
                            Structurally, hydromorphone derived from morphine in the modification of the hydroxyl group in the carbon 6 to a carbonyl and the absence of a double bond between the carbon 7 and 8. Due to these modifications, it presents a very high potency and comparable side effect profile to the parent compound.
                        </div>
                    </div>
                </div>
                <div>
